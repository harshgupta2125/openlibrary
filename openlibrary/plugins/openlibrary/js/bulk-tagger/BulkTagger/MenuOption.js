   ...
   */
    updateMenuOptionState (menuOptionState) {
        if (this.rootElement) {
            ...
            const statusIndicator = this.rootElement.querySelector(
                '.selected-tag__status',
            );
            switch (menuOptionState) {
            case MenuOptionState.NONE_TAGGED:
                statusIndicator.classList.remove(
                    'selected-tag__status--all-tagged',
                    'selected-tag__status--some-tagged',
                );
            ...
            throw new Error(
                'MenuOption must be initialized before state can be updated.',
            );
        }
    }
